...
public class Person {
    ...
    private boolean isPasswordValid(String password) {
        ...
        /*Эта строка использует метод System.out.printf для форматированного вывода значений переменных isDigit,
        isUpperCase, isLowerCase, и isSpecialSymbol в консоль, разделяя их символом |.
         */
