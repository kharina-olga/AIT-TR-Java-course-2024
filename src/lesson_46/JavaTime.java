...
//        System.out.println("text: " + text);
        ...
        System.out.println("year: " + date2.getYear() + "; month: " + "; month in digit: " + date2.getDayOfMonth());
        System.out.println("day: " + date2.getDayOfMonth() + "; day of week: " + date2.getDayOfWeek() + "; day of year: " + date2.getDayOfYear());
...
//        }
        ...
        System.out.println("date3: " + "Day Of Month: " + date3.getDayOfMonth() + " | " + "Number Of Month: " + date3.getMonthValue()+ " | " + "Year: " +  date3.getYear() + " | " + "Day Of Week: " + date3.getDayOfWeek());
