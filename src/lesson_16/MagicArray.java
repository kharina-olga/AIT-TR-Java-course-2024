...
public class MagicArray {
    ...
    // cursor — это указатель, который показывает,
    // где можно записать следующее число в массив. Если бы массив был шкафом с ящиками, то cursor — это номер свободного ящика,
    // в который можно положить новую вещь. Изначально cursor равен 0, то есть указывает на первый ящик (позицию) в массиве.
